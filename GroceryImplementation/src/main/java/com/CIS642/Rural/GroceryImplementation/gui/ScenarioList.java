...
import static com.CIS642.Rural.GroceryImplementation.gui.Window.STYLE_BACKGROUND_COLOR;
import static com.CIS642.Rural.GroceryImplementation.gui.Window.createSpinner;
...
public class ScenarioList {
    ...
    private static void refreshScenarioList(Stage stage, Window w, BorderPane layout, Scenario ss) {
        ...
        GroceryImplementationApplication.db.getAllScenarios(scenarios -> Platform.runLater(() -> {
    ...
    private static Scenario addNewScenario() {
        ...
        if (name.isPresent()) {
            ...
            GroceryImplementationApplication.db.persist(null, s);
            return s;
        } else {
            return null;
        }
