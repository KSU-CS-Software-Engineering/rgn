...
import com.CIS642.Rural.GroceryImplementation.db.MySQLDBDatabase;
...
public class Window extends Application {
    ...
    public void onConnectedToDB(String uri) {
        ...
        disconnectB.setOnAction(e -> {
            GroceryImplementationApplication.db.close(() -> Platform.runLater(() -> {
                GroceryImplementationApplication.db = null;
                onDisconnectedFromDB();
            }));
    ...
    public void onDisconnectedFromDB() {
        ...
        reconnectB.setOnAction(e -> {
            if (GroceryImplementationApplication.db != null) {
                GroceryImplementationApplication.db.close(null);
            }
            showDbInfoWindow();
        });
    ...
    private void showDbInfoWindow() {
        ...
        connectB.setOnAction(ae -> {
            ...
            GroceryImplementationApplication.db = db;
            ...
            GroceryImplementationApplication.db.open(url, dbName, user, password);
        });
