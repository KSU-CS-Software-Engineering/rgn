...
import com.CIS642.Rural.GroceryImplementation.arcgis.GISJob;
import com.CIS642.Rural.GroceryImplementation.arcgis.jobs.RequestTmpTokenJ;
...
public class ScenarioToolbox {
    ...
    public static Node create(Scenario s, Window owner) {
        ...
        addTextF(pane, "Name", s.name, t -> GroceryImplementationApplication.db.persist(() -> s.name = t, s));
        addTextAreaF(pane, "Description", s.description, t -> GroceryImplementationApplication.db.persist(() -> s.description = t, s));
        ...
        addTextF(arcGis, "Client ID", params[0], t -> {
            ...
            GroceryImplementationApplication.db.persist(() -> {
                s.arcGisClientID = t;
        ...
        addButton(dangerZone, "Delete scenario", () -> {
            ...
            if (result.isPresent() && result.get() == ButtonType.OK) {
                GroceryImplementationApplication.db.dropScenario(s);
                owner.closeScenario();
            }
        });
        addVSpace(pane, 50);
