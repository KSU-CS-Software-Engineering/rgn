...
VALUES
('About', 1, 'About',NULL),
('About', 2, 'Purpose of the Rural Grocery Connector','Many rural grocery stores have limited ordering capacity due to the size of the communities they serve.
    This makes it difficult for some rural grocery stores to meet minimum buying requirements from wholesale
    food distributors.'),
('About', 3, NULL ,'This distribution simulation map identifies potential partnerships between rural grocery stores that could
    combine orders to meet minimum buying requirements. The map creates various distribution scenarios.'),
('About', 4, 'About the data','The distribution simulation map contains data for all rural independent grocery stores in the state of Kansas,
    including:'),
('About', 5, NULL,'The name of the store'),
('About', 6, NULL,'Where it is located'),
